...
import { Users, Gift, TrendingUp, QrCode, Shield, Zap, Check, Star } from 'lucide-react'
...
export function LandingPreview({ config, scale = 0.5 }: LandingPreviewProps) {
  ...
  const benefits = [
    config.beneficio_1 || 'Beneficio 1',
    config.beneficio_2 || 'Beneficio 2',
    config.beneficio_3 || 'Beneficio 3',
  ]
