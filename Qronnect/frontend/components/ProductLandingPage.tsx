          ...
          <div className='max-w-7xl mx-auto'>
            <div className='grid lg:grid-cols-2 gap-12 items-center'>
              ...
              >
                ...
                <div className='absolute inset-0 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-3xl blur-3xl opacity-20 animate-pulse' />

                <div className='relative'>
                  {/* Main QR mockup card */}
                  <div className='bg-white rounded-3xl shadow-2xl p-6 md:p-8 border-2 border-gray-100 overflow-hidden'>
                    {/* Header */}
                    <div className='flex items-center justify-between mb-6'>
                      <div className='flex items-center gap-3'>
                        ...
                        <div>
                          <div className='font-bold text-gray-900 text-sm md:text-base'>Tu Código QR</div>
                          <div className='text-xs text-gray-600'>Escaneado 1,234 veces</div>
                        </div>
                      </div>
                    ...
                    <div className='bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-6 md:p-8 mb-6 relative overflow-hidden'>
                      {/* Decorative corners */}
                      <div className='absolute top-0 left-0 w-20 h-20 border-l-4 border-t-4 border-blue-600 rounded-tl-2xl'></div>
                      <div className='absolute top-0 right-0 w-20 h-20 border-r-4 border-t-4 border-blue-600 rounded-tr-2xl'></div>
                      <div className='absolute bottom-0 left-0 w-20 h-20 border-l-4 border-b-4 border-blue-600 rounded-bl-2xl'></div>
                      <div className='absolute bottom-0 right-0 w-20 h-20 border-r-4 border-b-4 border-blue-600 rounded-br-2xl'></div>

                      {/* QR Code center */}
                      <div className='aspect-square bg-white rounded-xl flex items-center justify-center shadow-xl border-4 border-white relative z-10 max-w-xs mx-auto'>
                        <div className='relative'>
                          <QrCode className='w-32 h-32 md:w-40 md:h-40 text-blue-600' strokeWidth={1.5} />
                          {/* Logo en centro del QR */}
                          <div className='absolute inset-0 flex items-center justify-center'>
                            <div className='w-12 h-12 bg-white rounded-lg shadow-lg flex items-center justify-center border-2 border-blue-600'>
                    ...
                    <div className='grid grid-cols-2 gap-3 md:gap-4'>
                      ...
                      >
                        <div className='flex items-center gap-2 mb-1'>
                          ...
                          <div className='text-2xl md:text-3xl font-bold text-green-600'>+42%</div>
                        </div>
                        <div className='text-xs text-gray-600 font-medium'>Visitas recurrentes</div>
                      </motion.div>

                      <motion.div
                        whileHover={{ scale: 1.05 }}
                        className='bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border border-purple-200 shadow-sm'
                      >
                        <div className='flex items-center gap-2 mb-1'>
                          <Users className='w-4 h-4 text-purple-600' />
                          <div className='text-2xl md:text-3xl font-bold text-purple-600'>+28%</div>
                        </div>
                        <div className='text-xs text-gray-600 font-medium'>Ticket medio</div>
                      </motion.div>

                      <motion.div
                        whileHover={{ scale: 1.05 }}
                        className='bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-200 shadow-sm'
                      >
                        <div className='flex items-center gap-2 mb-1'>
                      ...
                      <motion.div
                        whileHover={{ scale: 1.05 }}
                        className='bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-4 border border-orange-200 shadow-sm'
                      >
                        <div className='flex items-center gap-2 mb-1'>
                          <Zap className='w-4 h-4 text-orange-600' />
                          <div className='text-2xl md:text-3xl font-bold text-orange-600'>15min</div>
                        </div>
                        <div className='text-xs text-gray-600 font-medium'>Setup completo</div>
                      </motion.div>
                    </div>

                    {/* Mini CTA dentro del mockup */}
                    <div className='mt-6 pt-6 border-t border-gray-200'>
                      <button
                        ...
                        className='w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 text-sm'
                      >
                        Ver Cómo Funciona
