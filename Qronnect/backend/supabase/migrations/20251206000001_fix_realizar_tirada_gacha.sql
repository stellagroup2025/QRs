-- =====================================================
-- FIX: realizar_tirada_gacha - Corregir puntos_restantes
-- =====================================================
-- Fecha: 2025-12-06
-- Problema: puntos_restantes usaba valor ANTES de UPDATE
-- Solución: Obtener puntos actualizados después de UPDATE
